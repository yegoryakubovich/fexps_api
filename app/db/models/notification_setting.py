...
class NotificationSetting(Base):
    ...
    is_request_change = Column(Boolean, default=False)
    is_requisite_change = Column(Boolean, default=False)
    is_order_change = Column(Boolean, default=False)
    is_chat_change = Column(Boolean, default=False)
