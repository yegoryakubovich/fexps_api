...
class Method(Base):
    ...
    rate_input_default = Column(Integer, default=0)
    rate_output_default = Column(Integer, default=0)
    rate_input_commission_percent = Column(Integer, default=0)
    rate_output_commission_percent = Column(Integer, default=0)
    rate_input_commission_value = Column(Integer, default=0)
    rate_output_commission_value = Column(Integer, default=0)
