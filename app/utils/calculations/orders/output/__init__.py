...
async def calc_output(
    ...
    if currency_value:
        return await calc_output_currency_to_value(currency=currency, currency_value=currency_value)
    elif value:
        return await calc_output_value_to_currency(currency=currency, value=value)
