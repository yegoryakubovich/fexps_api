...
from .by_input_currency_value import calculate_request_rate_all_by_input_currency_value
from .by_output_currency_value import calculate_request_rate_all_by_output_currency_value


async def calculate_request_rate_all(
        input_method: Method,
    ...
    if input_currency_value:
        return await calculate_request_rate_all_by_input_currency_value(
