...
from .by_input_currency_value import calcs_request_rate_input_by_input_currency_value
from .by_input_value import calcs_request_rate_input_by_input_value


async def calcs_request_rate_input(
        input_method: Method,
    ...
    if input_currency_value:
        return await calcs_request_rate_input_by_input_currency_value(
            input_method=input_method,
            commission_pack=commission_pack,
            input_currency_value=input_currency_value,
        )
    elif input_value:
        return await calcs_request_rate_input_by_input_value(
            input_method=input_method,
            commission_pack=commission_pack,
