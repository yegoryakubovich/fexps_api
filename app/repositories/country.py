...
class CountryRepository(BaseRepository[Country]):
    ...
    async def get_by_id(self, id_: int) -> Optional[Country]:
    ...
    async def delete(self, db_obj: Country) -> Optional[Country]:
        return await self.update(db_obj, is_deleted=True)

    async def get_by_str_id(self, id_str: str) -> Optional[Country]:
